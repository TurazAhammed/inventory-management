...
export default function Inventory() {
  ...
  return (
    <SafeAreaView style={[styles.safeArea, styles.container, androidPadding]}>
              ...
              <View style={styles.item}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 8 }}>
                  <TouchableOpacity style={{ marginRight: 12 }} onPress={() => openEditModal(item)}>
                    <Text style={{ color: '#2563EB' }}>{t('common.edit') || 'Edit'}</Text>
                  </TouchableOpacity>
                  <TouchableOpacity onPress={() => confirmDelete(item.id)}>
                    <Text style={{ color: '#EF4444' }}>{t('common.delete') || 'Delete'}</Text>
                  </TouchableOpacity>
                </View>
              </View>
            )}
          ...
          <View style={{ backgroundColor: '#fff', borderRadius: 8, padding: 16 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 12 }}>
              <TouchableOpacity onPress={() => setEditingItem(null)} style={{ marginRight: 12 }}>
                <Text style={{ color: '#6B7280' }}>{t('common.cancel') || 'Cancel'}</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={saveEdit}>
                <Text style={{ color: '#10B981', fontWeight: '600' }}>{t('common.save') || 'Save'}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 24, fontWeight: '700', marginBottom: 12, color: '#1F2937' },
  ...
  calculatedPrice: { fontSize: 14, fontWeight: '500', color: '#E0244E', marginTop: 8 },
  totalPrice: { fontSize: 14, fontWeight: '600', color: '#34C759', marginTop: 8, marginBottom: 8 },
